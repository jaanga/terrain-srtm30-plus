...
//			}
		for ( var tileX = tileStartX; tileX < tileFinishX; tileX++ ) {
			...
			for ( var tileY = tileStartY; tileY < tileFinishY; tileY++ ) {
				...
				processTMS ( fileSRTM, countX, countY, tileX, tileY, pngXStart, pngXFinish, pngYStart, pngYFinish, pngWidth, tmsXStart, tmsXFinish, tmsYStart, tmsYFinish, tmsWidth, tmsHeight );
...
console.log( 'processSRTM' , fileSRTM );
	...
	function processTMS ( fileSRTM, countX, countY, tileX, tileY, pngXStart, pngXFinish, pngYStart, pngYFinish, pngWidth, tmsXStart, tmsXFinish, tmsYStart, tmsYFinish, tmsWidth, tmsHeight ) {
// console.log( 'ProcessTMS', countTMS++ );
		...
		map.src = '../../srtm-to-tms7/tms7-dev/' + tileX + '/' + tileY + '.png';
	...
	function procesTextLat( fileSRTM, countY, tileY, currentLatTop, pngYStart, pngYFinish, tmsYStart, tmsHeight ) {
		tileTextLat.innerHTML += countY + ' ty:' + tileY + ' lat:' + currentLatTop.toFixed(2) + ' y:' + pngYFinish + ' ht:' + tmsHeight + b;
	}

	function procesTextLon( fileSRTM, countX, tileX, pngXStart, pngXFinish, pngWidth, tmsXStart, tmsWidth ) {
