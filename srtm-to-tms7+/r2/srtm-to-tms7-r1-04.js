...
/*
		tms.pack().pipe( 
			fs.createWriteStream( __dirname + folderTMS7 + tileX + '/' + tileY + '.png' ) 
			.on('change', function () {
// console.log('written', tileX, tileY );
...
// console.log( 'l', countTMS, tileX, tileY, 'pxs/f', pngXStart, pngXFinish, 'pys/f', pngYStart, pngYFinish, 'ts', tmsYStart, 'tmsw/h', tmsWidth, tmsHeight, 'pw', pngWidth, 'tm', new Date() - startTime );
...
// console.log('log', countPNG, tileX, tileY );
		...
		fs.createReadStream( __dirname + folderTMS7 + tileX + '/' + tileY + '.png' )
			.pipe( new PNG() )
			.on('error', function() {
console.log('error', countPNG, tileX, tileY );
...
/*
				this.pack().pipe( fs.createWriteStream( __dirname + folderTMS7 + tileX + '/' + tileY + '.png' ) );
				countTMS++;
console.log( 'l', countTMS, tileX, tileY, 'pxs/f', pngXStart, pngXFinish, 'pys/f', pngYStart, pngYFinish, 'ts', tmsYStart, 'tmsw/h', tmsWidth, tmsHeight, 'pw', pngWidth, 'tm', new Date() - startTime );
		// console.log( 'l', countTMS, tmsIndex, tmsWidth * tmsHeight, tmsXStart, tmsYStart, tmsYFinish);
*/
