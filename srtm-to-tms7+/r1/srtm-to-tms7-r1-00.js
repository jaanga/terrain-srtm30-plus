...
// console.log( fileSRTM, tmsYStart, 'tsl', tileStartLat, 'ls', latStart, 'lf', latFinish, 'tsy', tileStartY, 'tfy', tileFinishY );
			...
			var pngYFinish = 0, tmsYStart, tmsHeight;
...
//		if ( countPNG < fileNames.length ) {
	...
	function processTMSnew( imageData, tileX, tileY, pngXStart, pngXFinish, pngYStart, pngYFinish, pngWidth, tmsXStart, tmsYStart, tmsWidth, tmsHeight) {
		...
		tms.pack().pipe( fs.createWriteStream( folderTMS7 + tileX + '/' + tileY + '.png' ) );
...
console.log( 'l', countTMS, tileX, tileY, 'pxs/f', pngXStart, pngXFinish, 'pys/f', pngYStart, pngYFinish, 'ts', tmsYStart, 'tmsw/h', tmsWidth, tmsHeight, 'pw', pngWidth, 'tm', new Date() - startTimeApp );
	...
	function processTMS( imageData, pngWidth, tmsWidth, xDelta, tmsXStart, tmsYStart, pngXStart, pngXFinish, pngYStart, pngYFinish, tmsHeight, tileX, tileY ) {
...
*/
			...
			.on('parsed', function () {
/*
console.log('parsed', countPNG, file );
				var pngIdx, tmsIdx;
				var tmsX, tmsY = tmsYStart;
...
//				this.pack().pipe( fs.createWriteStream( __dirname + '/test/test.png' )  );
				countTMS++;
// console.log( 'tms', countTMS, file, pngWidth, 'tw', tmsWidth, 'xo', tmsXStart, 'yo', tmsYStart, 'xs', pngXStart, 'xf', pngXFinish, 'ys', pngYStart, pngYFinish, 't', new Date() - startTimeApp);
*/
	...
	function processData( fileName, byteArray ) {
...
/*
		...
		tms.pack().pipe( fs.createWriteStream( folderNameOut + fileNames[ count ].slice( 0, -5 ) + '.png' ) );
